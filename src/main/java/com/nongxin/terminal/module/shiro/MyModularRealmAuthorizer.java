...
public class MyModularRealmAuthorizer extends ModularRealmAuthorizer {
    ...
    public boolean isPermitted(PrincipalCollection principals, String permission) {
        ...
        for (Realm realm : realms) {
            ...
            }else if (realm instanceof ShowRealm){
                realmHashMap.put("ShowRealm", realm);
            }
        }
        ...
        if (realmNames != null) {
            ...
            while (it.hasNext()) {
                ...
                }else if (realmName.contains("ShowRealm")) {
                    return ((ShowRealm) realmHashMap.get("ShowRealm")).isPermitted(principals, permission);
                }
                break;
            }
        }
