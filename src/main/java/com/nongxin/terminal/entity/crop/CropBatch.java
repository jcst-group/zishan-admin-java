...
public class CropBatch {
    ...
    private List<LotCalRel> lotCalRelList;

    public List<LotCalRel> getLotCalRelList() {
        return lotCalRelList;
    }

    public void setLotCalRelList(List<LotCalRel> lotCalRelList) {
        this.lotCalRelList = lotCalRelList;
    }
