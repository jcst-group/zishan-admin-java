...
public class BaseInfo {
    ...
    private BasetemplateRel basetemplateRel;

    public BasetemplateRel getBasetemplateRel() {
        return basetemplateRel;
    }

    public void setBasetemplateRel(BasetemplateRel basetemplateRel) {
        this.basetemplateRel = basetemplateRel;
    }
