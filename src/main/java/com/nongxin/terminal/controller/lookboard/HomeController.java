...
public class HomeController {
    ...
    public Result getBoardPesticideResidues(@RequestParam(required = true)Integer baseId){
        Result result = new Result();
        result.setSuccessResult(baseInfoService.getBoardPesticideResidues(baseId));
        return result;
    }
    ...
    @GetMapping("/getZsWorkOrder")
    @ApiOperation("/紫杉种植工单")
    public Result<List<ZsWorkOrder>> getListSort(ZsWorkOrder zsWorkOrder){
        Result<List<ZsWorkOrder>> result = new Result<>();
        result.setSuccessResult(zsWorkOrderService.getListSort(zsWorkOrder));
        return result;
    }
}
