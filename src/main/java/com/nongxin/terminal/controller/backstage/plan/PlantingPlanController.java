...
public class PlantingPlanController {
    ...
    @GetMapping("/selectByCropIdAndCalId")
    @ApiOperation("根据作物和计量单位查询种植计划")
    public Result selectByCropIdAndCalId(Integer cropId,Integer calId){
        Result result = new Result();
        result.setSuccessResult(plantingPlanService.selectByCropIdAndCalId(cropId,calId));
        return result;
    }
