...
public class RetroCodingController {
    ...
    public Result<PageInfo> getCropList(@RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
        ...
        List<RetroCoding> retroCodingList = retroCodingService.getRetroCoding(RetroCodingTypeEnum.RECO_BATCH,batchCode,retroCode);
    ...
    public Result getBatchByType(Integer batchId,RetroCodingTypeEnum type){
        Result result = new Result();
        result.setSuccessResult(retroCodingService.getResidualOutput(batchId,RetroCodingTypeEnum.RECO_BATCH));
        return  result;
    }
    ...
    public Result getRetroByRetroCode(String relationCode){
        ...
        result.setSuccessResult(retroCodingService.getRetroByRetroCode(relationCode,RetroCodingTypeEnum.RECO_BATCH));
        return  result;
    }
