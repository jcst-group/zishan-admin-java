...
public class EnumController {
    ...
    public Result getEnvStandardsEnum(){
        Result result = new Result();
        result.setSuccessResult(standardTypeService.list());
        return result;
    }

    @GetMapping("/getTemplateStandardType")
    @ApiOperation("获取某基地环境标准")
    public Result getEnvStandardsEnum(@RequestParam(required = true)Integer templateId){
        Result result = new Result();
        result.setSuccessResult(standardTypeService.getTemplateStandardType(templateId));
        return result;
    }
    ...
    @GetMapping("/getPlatformEnum")
    @ApiOperation("获取平台类型")
    public Result getPlatformEnum(){
        Result result = new Result();
        result.setSuccessResult(PlatformTypeEnum.values());
        return result;
    }
