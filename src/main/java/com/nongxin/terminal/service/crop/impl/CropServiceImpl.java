...
public class CropServiceImpl implements CropService {
    ...
    public boolean add(Crop crop) {
        try {
            ...
            List<PictureInfo> cropPicList = crop.getCropPicList();
            if (cropPicList != null && !cropPicList.isEmpty()){
                for (PictureInfo cropPic : cropPicList) {
            ...
            List<PictureInfo> ediblePicList = crop.getEdiblePicList();
            if (ediblePicList != null && !ediblePicList.isEmpty()){
                for (PictureInfo ediblePic : ediblePicList) {
                    ediblePic.setRelationId(crop.getId());
                    pictureInfoMapper.updateByPrimaryKeySelective(ediblePic);
                }
            }

            List<PictureInfo> medicinalPicList = crop.getMedicinalPicList();
            if (medicinalPicList != null && !medicinalPicList.isEmpty()){
                for (PictureInfo medicinalPic : medicinalPicList) {
