...
public class ProTraceabilityServiceImpl implements ProTraceabilityService {
    ...
    public Map<String, Object> getBatchAndBase(Integer batchId) {
        Map<String,Object> map = proTraceabilityMapper.getBatchAndBase(batchId);
        if (map != null){
            map.put("basePic",pictureInfoMapper.getBasePic((Integer) map.get("baseId")));
        }
        return map;
    }
    ...
    public Map<String, Object> getBatchAndBaseByRetroCode(String retroCode) {
        Map<String,Object> map = proTraceabilityMapper.getBatchAndBaseByRetroCode(retroCode);
        if (map != null){
            map.put("basePic",pictureInfoMapper.getBasePic((Integer) map.get("baseId")));
        }
        return map;
