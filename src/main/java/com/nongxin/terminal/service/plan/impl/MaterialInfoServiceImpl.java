...
public class MaterialInfoServiceImpl implements MaterialInfoService {
    ...
    @Override
    public List<PictureInfo> getMaterialPicByBatchId(Integer batchId) {
        return materialInfoMapper.getMaterialPicByBatchId(batchId);
    }

    @Override
    public List<PictureInfo> getMaterialPicByRetroCode(String retroCode) {
        return materialInfoMapper.getMaterialPicByRetroCode(retroCode);
    }
}
