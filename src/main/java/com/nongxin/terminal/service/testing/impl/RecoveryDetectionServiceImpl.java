...
public class RecoveryDetectionServiceImpl implements RecoveryDetectionService {
    ...
    @Override
    public PictureInfo getPicByRetroCode(String retroCode) {
        return recoveryDetectionMapper.getPicByRetroCode(retroCode);
    }

    @Override
    public PictureInfo getPicByBatchId(Integer batchId) {
        return recoveryDetectionMapper.getPicByBatchId(batchId);
    }
}
