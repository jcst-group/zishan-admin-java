...
public class RetroCodingServiceImpl implements RetroCodingService {
    ...
    public synchronized Result add(RetroCoding retroCoding) {
        ...
        try {
            ...
            codeInfo.setType(RetroCodingTypeEnum.RECO_BATCH);
            //根据采收批次查询产地和产量
            ...
            if(residualOutput.compareTo(consumption) > -1){
                ...
                retroOutputRel.setRelationType(RetroCodingTypeEnum.RECO_BATCH);
    ...
    public List<Map<String, Object>> getBatchByType(RetroCodingTypeEnum type,String condition) {
        /*List<Map<String, Object>> list = recoveryBatchMapper.getRecoveryByOutput(condition);
        ...
        return recoveryBatchMapper.getRecoveryByOutput(condition);
    }
