...
public class ClientPushCallback implements MqttCallback {
    ...
    private static final String TOPIC1 = "stds/up/CL/865650042739025";
    private static final String TOPIC2 = "stds/up/CL/865650041121878";
    private static final String TOPIC3 = "stds/up/CL/865650041122314";
    private static final String TOPIC4 = "stds/up/CL/865650041121837";
    private static final String TOPIC5 = "stds/up/CL/865650042732905";

    //设备上线topic
    private static final String TOPIC6 = "$SYS/brokers/emqx@127.0.0.1/clients/865650042739025/connected";
    private static final String TOPIC7 = "$SYS/brokers/emqx@127.0.0.1/clients/865650041121878/connected";
    private static final String TOPIC8 = "$SYS/brokers/emqx@127.0.0.1/clients/865650041121837/connected";
    private static final String TOPIC9 = "$SYS/brokers/emqx@127.0.0.1/clients/865650041122314/connected";
    private static final String TOPIC10 = "$SYS/brokers/emqx@127.0.0.1/clients/865650042732905/connected";

    //设备下线topic
    private static final String TOPIC11 =  "$SYS/brokers/emqx@127.0.0.1/clients/865650042739025/disconnected";
    private static final String TOPIC12 = "$SYS/brokers/emqx@127.0.0.1/clients/865650041121878/disconnected";
    private static final String TOPIC13 = "$SYS/brokers/emqx@127.0.0.1/clients/865650041121837/disconnected";
    private static final String TOPIC14 = "$SYS/brokers/emqx@127.0.0.1/clients/865650041122314/disconnected";
    private static final String TOPIC15 = "$SYS/brokers/emqx@127.0.0.1/clients/865650042732905/disconnected";
